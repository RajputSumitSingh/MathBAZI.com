...
// session_destroy(
  ...
  unset($_SESSION[$putcode_session_array_key]);
...
?>
    ...
    <section class="inner-page">
      ...
      <a style="width: 100%;" href="index.php" class="btn btn-secondary btn-lg active mt-3" role="button" aria-pressed="true">Recharge Home</a>
