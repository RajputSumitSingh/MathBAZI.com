  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <div class="logo mr-auto">
        <h1 class="text-light"><a href="../../">Math<i>BAZI</i></a></h1>
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          <li class="active"><a href="../../">MathBZI Home</a></li>
          <li><a href="index.php">Topic Wise Home</a></li>
          ...
          <?php
          if (!isset($_SESSION[$course_session_array_key]['IsLogin']) && $page_title!='Logedout') {
