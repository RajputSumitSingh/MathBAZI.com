        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact" id="contact" data-aos="fade-up">
            ...
            <p>
              ...
              United States <br><br> -->
              <strong>Phone:</strong> +917xxxxxxx6 <br>

              <strong>Whatsapp:</strong><a href='https://api.whatsapp.com/send?phone=917xxxxxxxx7' target="_blank" rel="noopener noreferrer"> 7291934297 or click here</a><br>
          ...
          <li class="active"><i class="bx bx-chevron-right"></i><a href="../../">Math<i>BAZI</i> Home</a></li>
          <li><i class="bx bx-chevron-right"></i><a href="index.php">Topic Wise Home</a></li>
...
if (isset($_SESSION[$course_session_array_key]['IsLogin'])) {
  ...
  echo '<li><i class="bx bx-chevron-right"></i><a href="user_account_details.php" target="_blank">My Click Account</a></li>';
