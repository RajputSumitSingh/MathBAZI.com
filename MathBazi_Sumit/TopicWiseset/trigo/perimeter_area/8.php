...
$screens = array();
	...
	$Ascreen["META"]["TYPE"] = "Question"; 
                   $Ascreen["DATA"][] = "Q. :-   Find the formula of area , and actual area of ground of rhombus shape ABCD , AB = CD = AD = BC = $b ,  perpendicular distance between any two sides  = $a.";
	...
	$Ascreen["META"]["TYPE"] = "Process"; 
                   ...
                   $Ascreen["DATA"][] = " So Area of Rhombus  =   (distance between these two parallel sides) x (length of one of these parallel sides) ";
